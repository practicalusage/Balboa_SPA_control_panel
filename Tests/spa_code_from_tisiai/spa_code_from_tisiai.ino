...
#define rxPinExternalSerialData 18
#define txPinExternalSerialData 17

#define RTS_PIN 21  // RS485 direction control, RequestToSend TX or RX, required for MAX485 board.


//WARNING
//Pin Keyboard
//>> modify with your PIN5 from your Keyboard
#define PIN_KEY_BOARD_1 5
#define PIN_KEY_BOARD_2 3  //my original Keyboard for debug FB Frame 
...
void sendCommandBuffer(uint8_t* buffer,int bufferLength)
{
  ...
  {
    printf("Command not sended > Original KeyBoard");
    return;
  }

  if(bufferLength<=0)
  {
    printf("Command not sended > No Data");
    return;
  }
